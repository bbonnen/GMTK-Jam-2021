...
public class PinataString : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        pinataLength = Mathf.Lerp(stringLengthRange.x, stringLengthRange.y, Mathf.InverseLerp(playerDistanceRange.x, playerDistanceRange.y, Mathf.Clamp(ropeDistance, playerDistanceRange.x, playerDistanceRange.y))); 
